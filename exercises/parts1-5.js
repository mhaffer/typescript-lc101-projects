...
// console.log(`${spacecraftName} would take ${speedMph} to get to Mars`);
...
//console.log(`${spaceShuttle.name} would take ${spaceShuttle.getDaysToLocation} to get to ${SpaceLocation}.`)
